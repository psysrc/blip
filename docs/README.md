...
- See [Ecosystem Design](design_ecosystem.md) for information about the Blip ecosystem and the `blip` tool.
This covers how Blip programs can be used; for example running them directly, or transpiling them into other languages.
